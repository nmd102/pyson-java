...
public class PysonWriter {
     ...
     * @param content the actual content you would like to add to the pyson file, as a single PysonEntry object
     */
     ...
     * Adds a pyson entry to a pyson file. Note that this will append to the file, not overwrite it
     * @param  filepath the filepath to the pyson file you would like to add your entry to
     * @param content the actual content you would like to add to the pyson file, as an array of PysonEntry objects
     */
    public static void addPysonEntry(String filepath, PysonEntry[] content) {
     ...
     * Adds a pyson entry to a pyson file. Note that this will append to the file, not overwrite it
     * @param  filepath the filepath to the pyson file you would like to add your entry to
     * @param content the actual content you would like to add to the pyson file as an ArrayList of PysonEntry objects
     */
