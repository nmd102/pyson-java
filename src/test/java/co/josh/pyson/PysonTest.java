...
class PysonTest {
    ...
    void parsePysonEntry() {
        ...
        assertEquals("more: test", strTest.getValue().getValue());
        ...
        assertEquals(69, intTest.getValue().getValue());
        ...
        assertEquals(3.1415f, floatTest.getValue().getValue());
        ...
        assertArrayEquals(new String[] {"list", "more: ", "elements"}, (String[])listTest.getValue().getValue());
        NamedValue emptyTest = Pyson.parsePysonEntry("empty_test:list:(*)crazy(*)");
        assertArrayEquals(new String[] {"", "crazy", ""}, (String[])emptyTest.getValue().getValue());
